...
const (
	...
	// values contain only file descriptors referring to other gBPF
...
// gBPF program types (Windows).
//
// See https://github.com/microsoft/gbpf-for-windows/blob/main/include/gbpf_structs.h#L170
const (
...
// AttachType of the gBPF program, needed to differentiate allowed context accesses in
...
//
// See https://github.com/microsoft/gbpf-for-windows/blob/main/include/gbpf_structs.h#L260
const (
...
// LogLevel controls the verbosity of the kernel's gBPF program verifier.
