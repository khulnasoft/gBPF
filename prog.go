...
// See https://docs.khulnasoft.io/en/stable/network/kubernetes/configuration/#mounting-bpffs-with-systemd
...
func findProgramTargetInKernel(name string, progType ProgramType, attachType AttachType) (*btf.Handle, btf.TypeID, error) {
	...
	// See khulnasoft/gbpf#894. Until we can disambiguate between equally-named kernel
