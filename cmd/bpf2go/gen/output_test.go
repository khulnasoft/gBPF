...
import (
	...
	"github.com/khulnasoft/gbpf/cmd/bpf2go/internal"
)
...
func TestObjects(t *testing.T) {
	...
	qt.Assert(t, qt.StringContains(str, "Map1 *gbpf.MapSpec `gbpf:\"map1\"`"))
	qt.Assert(t, qt.StringContains(str, "Var1 *gbpf.VariableSpec `gbpf:\"var_1\"`"))
	qt.Assert(t, qt.StringContains(str, "ProgFoo1 *gbpf.ProgramSpec `gbpf:\"prog_foo_1\"`"))

	qt.Assert(t, qt.StringContains(str, "Map1 *gbpf.Map `gbpf:\"map1\"`"))
	qt.Assert(t, qt.StringContains(str, "Var1 *gbpf.Variable `gbpf:\"var_1\"`"))
	qt.Assert(t, qt.StringContains(str, "ProgFoo1 *gbpf.Program `gbpf:\"prog_foo_1\"`"))
}
