...
type bpfProgramSpecs struct {
	KprobeExecve *gbpf.ProgramSpec `gbpf:"kprobe_execve"`
}
...
type bpfMapSpecs struct {
	KprobeMap *gbpf.MapSpec `gbpf:"kprobe_map"`
}
...
// It can be passed to loadBpfObjects or gbpf.CollectionSpec.LoadAndAssign.
type bpfMaps struct {
	KprobeMap *gbpf.Map `gbpf:"kprobe_map"`
}
...
type bpfPrograms struct {
	KprobeExecve *gbpf.Program `gbpf:"kprobe_execve"`
}
