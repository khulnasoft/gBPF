...
type bpfProgramSpecs struct {
	UretprobeBashReadline *gbpf.ProgramSpec `gbpf:"uretprobe_bash_readline"`
}
...
type bpfMapSpecs struct {
	Events *gbpf.MapSpec `gbpf:"events"`
}
...
type bpfPrograms struct {
	UretprobeBashReadline *gbpf.Program `gbpf:"uretprobe_bash_readline"`
}
