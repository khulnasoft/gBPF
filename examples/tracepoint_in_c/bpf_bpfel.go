...
type bpfProgramSpecs struct {
	MmPageAlloc *gbpf.ProgramSpec `gbpf:"mm_page_alloc"`
}
...
type bpfMapSpecs struct {
	CountingMap *gbpf.MapSpec `gbpf:"counting_map"`
}
...
// It can be passed to loadBpfObjects or gbpf.CollectionSpec.LoadAndAssign.
type bpfMaps struct {
	CountingMap *gbpf.Map `gbpf:"counting_map"`
}
...
type bpfPrograms struct {
	MmPageAlloc *gbpf.Program `gbpf:"mm_page_alloc"`
}
