...
import (
	...
	"github.com/khulnasoft/gbpf/internal/kconfig"
...
type CollectionSpec struct {
	...
	// loading has no effect on a running gBPF program.
...
// has an `gbpf` tag and its type is *ProgramSpec, *MapSpec or *VariableSpec.
...
//	    Var     *gbpf.VariableSpec `gbpf:"some_var"`
//	    Ignored int
//	}
//
