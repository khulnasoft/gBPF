...
func TestVariable(t *testing.T) {
	...
	obj := struct {
		GetBSS      *Program `gbpf:"get_bss"`
		GetData     *Program `gbpf:"get_data"`
		CheckStruct *Program `gbpf:"check_struct"`

		BSS    *Variable `gbpf:"var_bss"`
		Data   *Variable `gbpf:"var_data"`
		Struct *Variable `gbpf:"var_struct"`
		Array  *Variable `gbpf:"var_array"`
	}{}
...
func TestVariableConst(t *testing.T) {
	...
	obj := struct {
		GetRodata *Program  `gbpf:"get_rodata"`
		Rodata    *Variable `gbpf:"var_rodata"`
	}{}
